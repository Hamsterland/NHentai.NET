...
## Installation
You can install the latest build from [NuGet](https://www.nuget.org/packages/NHentai.NET/2.0.1) or through the .NET CLI using the command
```
dotnet add package NHentai.NET --version 2.0.1
```

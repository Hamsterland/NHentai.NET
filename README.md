...
## Installation
You can install the latest build from [NuGet](https://www.nuget.org/packages/NHentai.NET/2.1.0) or through the .NET CLI using the command
```
dotnet add package NHentai.NET --version 2.1.0
```
